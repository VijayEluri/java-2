...
// Adapt from https://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/SuffixArrayX.java.html
//
public class CircularSuffixArray {
    ...
    public CircularSuffixArray(String s) {
        if (s == null) {
            throw new IllegalArgumentException("Input string s is null");
        }
        n = s.length();
        s = s + '\0';
    ...
    public int index(int i) {
        if (i < 0 || i > n - 1) {
            throw new IllegalArgumentException("Input index i outside the prescribed range");
        }
        return index[i];
    }
